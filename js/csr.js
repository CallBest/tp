...
function getFillGallons() {
  var tanksize = document.getElementById("tanksize").value;
  var percentremaining = document.getElementById("percentremaining").value;
  var fillgallons;
  if (tanksize && percentremaining) {
    fillgallons = Math.floor(tanksize * ((85 - percentremaining) / 100));
    document.getElementById("maxfill").value = fillgallons;
  }
}
...
function copyToBilling() {
  if (document.getElementById("billingaddress").value == '') {
    ...
    document.getElementById("billingcity").value = document.getElementById("addresscity").value
    document.getElementById("billingcounty").value = document.getElementById("addresscounty").value
    document.getElementById("billingstate").value = document.getElementById("addressstate").value
    document.getElementById("billingzipcode").value = document.getElementById("addresszipcode").value
  } else {
    alert('Billing address fields should be empty to proceed.');
  }
}

function doSearch() {
  if ((document.getElementById("searchlastname").value == '') && (document.getElementById("searchphone").value == '')) {
    alert('Provide last name or phone number to proceed with the search.');
    return false;
  } else {
    return true;
  }
...
function calculateOrder() {
  var addtankprice = 0.00;
  var tankorder = '';
  if (document.getElementById('newtankorder').checked) {
  ...
  var ordertype = '';
  if (document.getElementById('newfillorder').checked) {
